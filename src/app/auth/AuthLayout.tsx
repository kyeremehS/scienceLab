...
export function AuthLayout({
  ...
  return (
    <div className="flex min-h-full flex-1 flex-col lg:flex-row">
      ...
      <div className="flex flex-col justify-center bg-zinc-100 px-8 py-8 text-zinc-900 min-[480px]:py-10 lg:w-[45%] lg:items-end lg:px-12 dark:bg-zinc-950 dark:text-zinc-50">
        <div className="mx-auto w-full max-w-md">
          ...
          <CircuitIllustration className="mt-6 w-full max-w-[280px] min-[480px]:max-w-sm lg:max-w-md" />
        </div>
      </div>
      ...
      <main className="relative flex flex-1 items-start justify-center px-6 py-8 lg:items-center lg:justify-start lg:py-12 lg:pl-12 xl:pl-20">
        ...
        <div className="w-full max-w-[480px]">
          ...
          <p className="mt-1 text-sm text-zinc-600 dark:text-zinc-400">{subheading}</p>
